...
namespace BusinessLayer.ValidationRules
{
    public class ProductValidator : AbstractValidator<Product>
    {
        ...
        {
            //RuleFor(x => x.ProductID).NotEmpty().WithMessage("Product ID alanı boş geçilemez.");
            //RuleFor(x => x.SellTraderID).NotEmpty().WithMessage("Sell Trader ID alanı boş geçilemez.");
            //RuleFor(x => x.BuyTraderID).NotEmpty().WithMessage("Buy Trader ID alanı boş geçilemez.");
            ...
            RuleFor(x => x.StatusProduct).NotEmpty().WithMessage("Ürün durumu alanı boş geçilemez.");
            ...
            //RuleFor(x => x.GenreCategoryID).NotEmpty().WithMessage("Genre Category ID alanı boş geçilemez.");
        }
    }
}
